...
class CombatBattleDialog extends BattleDialog {
	...
	public function new(quadrant: Int) {
		...
		loadBackground("assets/images/bg-combat-dialog.png", 56, 72);
		...
		atkHP = new FlxText(x + labelsWidth + statsWidth, y + nameLineHeight, statsWidth, "");
		atkHP.alignment = FlxTextAlign.RIGHT;
		atkHP.setFormat("assets/fonts/pixelmini.ttf", FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(atkHP);

		atkDmg = new FlxText(x + labelsWidth + statsWidth + 2, y + nameLineHeight + lineHeight, statsWidth - 2, "");
		atkDmg.alignment = FlxTextAlign.RIGHT;
		atkDmg.setFormat("assets/fonts/pixelmini.ttf", FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(atkDmg);

		atkHitR = new FlxText(x + labelsWidth + statsWidth, y + nameLineHeight + 2 * lineHeight, statsWidth, "");
		...
		atkCrtR = new FlxText(x + labelsWidth + statsWidth, y + nameLineHeight + 3 * lineHeight, statsWidth, "");
		...
		defCrtR = new FlxText(x + paddingLeft, y + nameLineHeight + 3 * lineHeight, statsWidth, "");
		...
		var labelHP = new FlxText(x + statsWidth + paddingLeft, y + nameLineHeight, labelsWidth, "HP");
		...
		var labelDmg = new FlxText(x + statsWidth + paddingLeft, y + nameLineHeight + lineHeight, labelsWidth + 2, "Dmg");
		...
		var labelHitRate = new FlxText(x + statsWidth + paddingLeft, y + nameLineHeight + 2 * lineHeight, labelsWidth, "Hit");
		...
		var labelCritRate = new FlxText(x + statsWidth + paddingLeft, y + nameLineHeight + 3 * lineHeight, labelsWidth, "Crt");
